...
assert.match(student,/data-shop-slot=\"hair\"/,'학생 상점에서 머리 아이템을 볼 수 있어야 합니다.');
assert.match(student,/data-shop-slot=\"hat\"/,'학생 상점에서 모자 아이템을 볼 수 있어야 합니다.');
assert.match(student,/data-shop-slot=\"glasses\"/,'학생 상점에서 안경 아이템을 볼 수 있어야 합니다.');
assert.doesNotMatch(student,/filter\(item=>!\['face','expression','hair','hat','glasses'\]/,'학생 상점이 교사가 허용한 꾸미기 종류를 숨기면 안 됩니다.');
