...
assert.ok(pos('game.js')<pos('student-direct-movement.js')&&pos('student-direct-movement.js')<pos('onboarding.js'),'game, direct movement, and guide must load in deterministic order');
