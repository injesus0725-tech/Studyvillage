...
for(const src of [server,riddle]){
  ...
  assert.ok(src.includes('새 마을 친구 “${npc.name}”을 만날 수 있게 되었습니다!')||src.includes('새 마을 친구 “${npcUnlock.name}”을 만날 수 있게 되었습니다!'),'the announcement must identify the verified unlocked NPC');
}
