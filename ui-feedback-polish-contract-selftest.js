...
assert.ok(!src.includes('wardrobeButton.click()')&&src.includes('panel.hidden = false')&&shop.includes("querySelector('#shop-button')"),'상점 버튼은 옷장 버튼을 대신 누르지 않고 직접 구매 화면을 열어야 합니다.');
