...
assert.match(hub,/id:'math-all'/,'all-math expedition must be available');
assert.match(hub,/id:'math-mul-div'/,'multiplication/division expedition must be available');
