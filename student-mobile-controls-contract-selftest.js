...
assert.ok(!html.includes('class="mobile-controls"'),'legacy direction-pad markup must be fully removed from the student page');
...
assert.ok(!movement.includes('movementKeys'),'direct movement must not retain keyboard/d-pad ownership');
...
console.log('student pointer controls retirement contract selftest passed');
