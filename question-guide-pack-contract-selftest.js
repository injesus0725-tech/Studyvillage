...
for(const token of ["import('../question-guide-packs.js')",'guidePacksReady','await guidePacksReady'])assert.ok(loader.includes(token),`guide packs must load before teacher filtering: ${token}`);
