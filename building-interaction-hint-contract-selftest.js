...
assert.ok(src.includes("function hideHint(){if(hint)hint.classList.remove('visible');document.body.classList.remove('near-building-interaction')}"),'building interaction hint needs a shared hide helper that also clears the proximity state');
