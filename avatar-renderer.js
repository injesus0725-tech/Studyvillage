...
window.StudyVillageAvatar=(()=>{
  ...
  const body=(skin='#ffd2ad',shirt='#e8f0f5')=>frame(`<g ${stroke}><path fill="${skin}" d="M27 32q1-20 21-20t21 20v19q0 18-21 18T27 51z"/><path fill="${skin}" d="M25 39h3v13h-3q-4-6 0-13zm46 0h-3v13h3q4-6 0-13z"/><ellipse fill="#4b3834" stroke="none" cx="37" cy="43" rx="2.2" ry="3.4"/><ellipse fill="#4b3834" stroke="none" cx="59" cy="43" rx="2.2" ry="3.4"/><circle fill="#fff" stroke="none" cx="37.6" cy="42" r=".7"/><circle fill="#fff" stroke="none" cx="59.6" cy="42" r=".7"/><ellipse fill="#f4a5a2" stroke="none" cx="32" cy="51" rx="4" ry="2"/><ellipse fill="#f4a5a2" stroke="none" cx="64" cy="51" rx="4" ry="2"/><path fill="none" d="M43 56q5 5 10 0"/><path fill="${skin}" d="M43 67h10v8H43zM22 78q0-5 5-5h4v31h-9zm43-5h4q5 0 5 5v26h-9zM34 106h12v23H34zm16 0h12v23H50z"/><path fill="${shirt}" d="M31 71q17-5 34 0l2 38H29z"/><path fill="#554844" d="M31 125h16v11H28q-3-5 3-11zm18 0h16q6 6 3 11H49z"/></g>`);
