...
for(const token of ['safeReturn','cleanupVillage','inside-building','building-interior','studyvillage:return-to-village','dataset.riddleCompletionReturn'])assert.ok(guard.includes(token),`riddle completion guard missing ${token}`);
