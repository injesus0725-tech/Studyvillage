...
export function safeQuestionSnapshot(q={}){return{word:clean(q.word,300),question:clean(q.question,1000),prompt:clean(q.prompt,1000),options:Array.isArray(q.options)?q.options.slice(0,12).map(v=>clean(v,500)):[],answer:Number.isInteger(Number(q.answer))?Number(q.answer):null}}
