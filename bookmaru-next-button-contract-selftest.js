...
assert.match(game,/function returnVillage\(\)\{panel\.hidden=true;window\.dispatchEvent\(new Event\('studyvillage:return-to-village'\)\)\}/,'Bookmaru return action must close the activity and restore the village flow');
