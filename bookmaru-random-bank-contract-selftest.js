...
assert.ok(game.includes("const ACTIVITY_ID='vocabulary',ROUND_SIZE=5"),'Bookmaru must draw five questions per challenge');
...
assert.ok(game.includes('수수께끼·어휘·상식·교과서 문제'),'the student guide must describe the cumulative mixed question bank');
