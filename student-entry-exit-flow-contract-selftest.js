...
assert.ok(!game.includes("studyvillage:first-character-choice"),'successful student login must not be blocked by a first-character modal');
assert.ok(!onboarding.includes("studyvillage:first-character-choice"),'onboarding must remain manual-only and independent from account creation');
