...
for(const name of ['peter-pan-boy.png','peter-pan-girl.png','hello-kitty-boy.png','hello-kitty-girl.png','kuromi.png','my-melody.png','cinnamoroll.png','pompompurin.png'])assert.ok(listed.some(rel=>rel.endsWith(name)),`${name} 완전체 캐릭터가 카탈로그에 필요합니다.`);
