...
for(const token of [
  ...
  "RETIRED_ACTIVITY_IDS=new Set(['riddle-demo','exploration-social','exploration-science','exploration-math'])",
  "'library-vocabulary':Object.freeze({mode:'limited',limit:1",
  "'math-arithmetic':Object.freeze({mode:'limited',limit:3",
  "'exploration-math-addition':Object.freeze({mode:'limited',limit:3",
  "'exploration-math-multiplication':Object.freeze({mode:'limited',limit:3",
...
for(const retired of ["'riddle-demo':Object.freeze","'exploration-social':Object.freeze","'exploration-science':Object.freeze","'exploration-math':Object.freeze"])assert.ok(!settings.includes(retired),`retired active policy returned: ${retired}`);
assert.ok(settings.includes("legacyMathPolicy=checked.ok&&checked.policies['exploration-math']")&&settings.includes("saved['exploration-math-addition']")&&settings.includes("saved['exploration-math-multiplication']"),'legacy combined teacher limit must seed both split math policies');
for(const token of [
