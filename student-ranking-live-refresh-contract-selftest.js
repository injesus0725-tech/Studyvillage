...
assert.ok(customize.includes("window.dispatchEvent(new Event('studyvillage:ranking-refresh'));return true"),'saved character equipment must refresh ranking avatars');
