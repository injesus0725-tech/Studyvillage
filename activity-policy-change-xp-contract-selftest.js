...
for(const pattern of [
  ...
  /nextGained\s*=\s*latestDecision\.awardXp\?growthAdjustedXp\(latestPlayer\.xp,baseXp\):0/,
...
const decisionAt=tx.search(/latestDecision\s*=\s*evaluateWithExtra/),gainAt=tx.search(/nextGained\s*=\s*latestDecision\.awardXp\?growthAdjustedXp/),writeAt=tx.indexOf('UPDATE players SET xp=xp+?');
