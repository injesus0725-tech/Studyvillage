...
assert.ok(onboarding.includes('Login enters the playable village immediately.')&&!onboarding.includes('studyvillage:first-character-choice'),'onboarding must remain manual-only after login');
