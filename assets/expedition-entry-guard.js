...
(()=>{
  ...
  function normalizeTerminalResult(stage){
    ...
    button.onclick=()=>{stage.hidden=true;const hub=document.querySelector('#student-explore-panel');if(hub)hub.hidden=true;document.body.classList.remove('study-expedition-active');document.querySelector('#exploration-cave')?.focus?.()};
  }
