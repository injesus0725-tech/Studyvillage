...
(()=>{
  ...
  function eligible(q){return(q.spaces||[]).includes('exploration')&&q.type!=='input'&&Array.isArray(q.options)&&q.options.length>=2&&(window.StudyVillageQuestionCatalog?.eligible?.(q,'exploration')??true)}
