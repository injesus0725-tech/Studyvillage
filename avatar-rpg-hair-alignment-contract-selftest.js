...
assert.ok(html.includes('assets/avatar-alignment-overhaul-v1.css?v=20260830b'),'student build must load the latest wardrobe/ranking alignment pass');
...
console.log('avatar RPG hair, full wardrobe/ranking alignment, and special-character differentiation contract passed');
