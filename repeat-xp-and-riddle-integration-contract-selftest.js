...
for(const id of ['exploration-korean','exploration-math-addition','exploration-math-multiplication','exploration-random']){
...
assert.ok(policy.includes("RETIRED_ACTIVITY_IDS=new Set(['riddle-demo','exploration-social','exploration-science','exploration-math'])"),'old saved retired policies must be filtered');
