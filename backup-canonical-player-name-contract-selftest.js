...
assert.ok(src.includes("replace(/\\s+/g,' ')"),'backup player names must match login whitespace normalization');
console.log('backup canonical player name and login-normalization contract self-test passed');
