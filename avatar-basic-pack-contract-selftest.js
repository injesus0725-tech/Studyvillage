...
const expected=['v2/bases/study-boy-v2.png','v2/bases/study-girl-v2.png','v2/hair/natural-wavy-v1.png','v2/outfits/camp-explorer-v1.png','v2/pets/cream-pup-v1.png'];
...
for(const id of ['hair-natural-wavy-v2','outfit-camp-explorer-v2','effect-starlight-v2','pet-cream-pup-v2']){assert.ok(catalog.includes(`'${id}'`),`active one-set catalog missing ${id}`);assert.ok(renderer.includes(`'${id}'`),`renderer missing ${id}`)}
