...
const expected=['v2/bases/study-boy-v2.png','v2/bases/study-girl-v2.png','v2/hair/natural-wavy-v1.png','v2/outfits/camp-explorer-v1.png','v2/outfits/detective-v1.png','v2/outfits/firefighter-v1.png','v2/outfits/forest-fairy-v1.png','v2/pets/cream-pup-v1.png'];
...
for(const id of ['hair-natural-wavy-v2','outfit-camp-explorer-v2','outfit-detective-v2','outfit-firefighter-v2','outfit-forest-fairy-v2','effect-starlight-v2','pet-cream-pup-v2']){assert.ok(catalog.includes(`'${id}'`),`active one-set catalog missing ${id}`);assert.ok(renderer.includes(`'${id}'`),`renderer missing ${id}`)}
...
assert.ok(customize.includes("const slots=['hair','outfit','effect','pet']"),'wardrobe must expose the complete one-set equipment');
...
assert.ok(adminHtml.includes('avatar-renderer.js?v=20260903hair1'),'teacher mode must load the canonical renderer');
