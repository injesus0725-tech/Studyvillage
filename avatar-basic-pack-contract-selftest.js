...
const expected=['v2/bases/study-boy-v2.png','v2/bases/study-girl-v2.png','production/characters/peter-pan-boy.png','production/characters/peter-pan-girl.png','v2/pets/cream-pup-v1.png'];
...
for(const id of ['character-peter-pan-boy','character-peter-pan-girl','effect-starlight-v2','pet-cream-pup-v2']){assert.ok(catalog.includes(`'${id}'`),`active complete-character catalog missing ${id}`);assert.ok(renderer.includes(`'${id}'`),`renderer missing ${id}`)}
...
assert.ok(adminHtml.includes('avatar-renderer.js?v=20260907complete1'),'teacher mode must load the complete-character renderer');
