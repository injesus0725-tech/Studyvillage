...
assert.ok(css.includes('width:145%!important')&&css.includes('object-fit:fill!important'),'square PNG avatar art must be normalized onto the tall modular canvas');
