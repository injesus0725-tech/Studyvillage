...
assert.ok(html.includes('admin-delivery-notifications.js?v=20260909sticky1')&&html.includes('admin-quick-navigation.js?v=20260909sticky2'),'admin sticky controls must use fresh cache keys');
