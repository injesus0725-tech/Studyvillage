...
assert.ok(game.includes("replaceChildren('긴급빌드 20260824-1')"),'student login screen must show the emergency build marker');
assert.ok(admin.includes("marker.textContent='긴급빌드 20260824-1'"),'teacher screen must show the emergency build marker');
