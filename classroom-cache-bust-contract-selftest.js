...
assert.ok(server.includes("const BUILD_ID='20260825-r7-admin-dialog'"),'the packaged classroom server must expose an unmistakable build id');
...
assert.ok(admin.includes("marker.textContent='관리자입력 R7 · 20260825'"),'teacher screen must show the unique recovery build marker');
