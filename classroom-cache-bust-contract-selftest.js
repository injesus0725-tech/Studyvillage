...
assert.ok(server.includes("const BUILD_ID='20260825-v1-sound'"),'the packaged classroom server must expose an unmistakable build id');
...
assert.ok(game.includes("replaceChildren('효과음 V1 · 20260825')"),'student login screen must show the unique recovery build marker');
