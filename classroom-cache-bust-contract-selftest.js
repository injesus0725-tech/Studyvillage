...
assert.ok(server.includes("const BUILD_ID='20260825-r9-content-plan'"),'the packaged classroom server must expose an unmistakable build id');
...
assert.ok(game.includes("replaceChildren('콘텐츠정리 R9 · 20260825')"),'student login screen must show the unique recovery build marker');
