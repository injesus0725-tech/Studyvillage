...
for(const [slot,label] of [['all','전체'],['character','기본 캐릭터'],['hair','머리'],['outfit','한벌 의상'],['effect','효과'],['pet','펫'],['physical','실물']])assert.ok(src.includes(`data-admin-shop-slot="${slot}"`),`${label} 관리자 상점 필터가 필요합니다.`);
