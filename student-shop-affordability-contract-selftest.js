...
assert.ok(src.includes('b.disabled=bought||limitReached||!available||salePending||saleEnded||!levelOk||!affordable||busy'),'unaffordable and purchase-limited items must not send avoidable purchase requests');
