...
assert.match(client,/Number\(data\.rewardStars\)/,'mission UI must display the server-authoritative reward');
assert.match(html,/<script src="daily-missions\.js(?:\?[^\"]+)?"><\/script>/,'daily mission UI must load');
