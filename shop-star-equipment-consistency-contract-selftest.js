...
assert.ok(equipment.indexOf('repairWardrobeData(db,name,player)')<equipment.indexOf('UPDATE players SET equipment_json=?'),'equipment save must repair legacy wardrobe and equipment state before writing');
