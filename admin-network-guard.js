...
(()=>{
  const marker=document.createElement('div');marker.textContent='관리자입력 R7 · 20260825';marker.style.cssText='position:fixed;right:8px;bottom:6px;z-index:99999;padding:4px 7px;border-radius:7px;background:#203f2e;color:#fff;font:700 11px system-ui';document.body.appendChild(marker);
