...
(()=>{
  const marker=document.createElement('div');marker.textContent='균형조정 R5 · 20260825';marker.style.cssText='position:fixed;right:8px;bottom:6px;z-index:99999;padding:4px 7px;border-radius:7px;background:#203f2e;color:#fff;font:700 11px system-ui';document.body.appendChild(marker);
  ...
  const runtime=document.createElement('script');runtime.src='/assets/admin-runtime-fixes.js?v=20260825r7';runtime.async=false;document.head.appendChild(runtime);
